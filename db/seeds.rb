...
if ENV['RAILS_ENV'] != 'test'
  ...
  seventh_book.user = first_user
  seventh_book.cover.attach(io: File.open('db/covers/unix.jpg'), filename: 'unix.jpg')
  seventh_book.save

  eight_book = Book.new({ name: 'Высоконагруженные приложения',
                          authors: 'Мартин Клеппман', annotation: 'В этой книге вы найдете ключевые принципы, алгоритмы и компромиссы, без которых не обойтись при разработке высоконагруженных систем для работы с данными. Материал рассматривается на примере внутреннего устройства популярных программных пакетов и фреймворков. В книге три основные части, посвященные, прежде всего, теоретическим аспектам работы с распределенными системами и базами данных. От читателя требуются базовые знания SQL и принципов работы баз данных.' })
  eight_book.user = second_user
  eight_book.cover.attach(io: File.open('db/covers/highload.jpeg'), filename: 'highload.jpeg')
  eight_book.save
